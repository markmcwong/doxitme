                        ...
                        <div className="row">
                            <div className="col-lg-10 offset-lg-1">
                                <div className="search_title_area">
                                    <h2 className="title">Find the Best Tutor</h2>
                                    <p className="sub_title">Lorem ipsum dolor sit amet, consectetur adipiscing elit..</p>
                                </div>{/* ends: .search_title_area */}
                                <ul className="nav nav-tabs" id="myTab" role="tablist">
                                    <li className="nav-item col">
                                        <a className="nav-link active text-center" data-toggle="tab" href="#issue"
                                           role="tab" aria-controls="home" aria-selected="true">Issue a ticket</a>
                                    </li>
                                    <li className="nav-item col">
                                        <a className="nav-link text-center" data-toggle="tab" href="#find"
                                           role="tab" aria-controls="profile" aria-selected="false">Find a ticket</a>
                                    </li>
                                </ul>
